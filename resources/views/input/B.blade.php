  ...
  <div class="col-md-9">
    <div class="card card-outline card-lightblue">
      ...
      <div class="card-body">
        ...
        @endif
        @foreach ($inputB as $k => $v)
        <form method="POST" action="{{ route('input.B', $user->id) }}" enctype="multipart/form-data">@csrf
          ...
          <div class="text-right">
            @if ($k != 0)
            <a href="{{ route('input.B.delete', [$id, $v->id]) }}" class="btn btn-danger btn-flat btn-xs mb-3"><i class="fa fa-trash"></i> Hapus</a>
            @endif
            <a href="{{ route('input.B.add', $id) }}" class="btn btn-primary btn-flat btn-xs mb-3"><i class="fa fa-add"></i> Tambah</a>
